...
"D:\Microsoft Visual Studio\2022\Community\Common7\IDE\CommonExtensions\Microsoft\CMake\CMake\bin\cmake.exe" --build build

copy build\plugin_ximea\debug\plugin_ximea.dll build\debug
copy build\plugin_centroiding\debug\plugin_centroiding.lib build\debug
