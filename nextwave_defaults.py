...
BATCH_OUTPUT_DIR="zernikes" # File > "Process directory of AVIs": the CSVs and the summary plots go in this subdirectory of the movies' directory
SUMMARY_PLOT_YLIM=(-1.0, 1.0) # The summary plot's shared y range (um); values outside it are cut off
